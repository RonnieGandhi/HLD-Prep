...
| 4 | [Distributed Worker Queue (RabbitMQ / SQS)](Problems/31_1_Distributed_Worker_Queue) | Infrastructure | ⭐⭐⭐⭐ Hard | Partitioning & consumer groups, exactly-once semantics, ISR replication, offset management, dead-letter queues, backpressure — **foundational** for half the other problems |
